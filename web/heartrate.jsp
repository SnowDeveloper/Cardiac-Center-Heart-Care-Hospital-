...
<section class="page-title">
    <div class="grid-row clearfix">
        <h1>Heart-Rate Online Test</h1>

        <nav class="bread-crumbs">
            <a href="index.jsp">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;
            <a href="heartrate.jsp">Heart-Rate-Test</a>
        </nav>
    </div>
</section>
<!--/ page title -->
    ...
    <div class="grid-row">
        <div class="grid-col grid-col-20">
            <section class="detailed-services wpb_content_element">
                <div class="widget-title">How old is your heart?</div>
                <div>
                    <img src="pic/Heart1.jpg" style="width: 485px; float: left; margin-bottom: 50px; margin-right: 70px;" hspace="35">
                    <img src="pic/Heart2.jpg" style="width: 485px; float: right; margin-bottom: 50px; margin-right: 13px;" hspace="35"></br>
                </div></br>

                <div>
                    </br><img src="pic/Heart3.jpg" style="width: 485px; float: left; margin-bottom: 50px; margin-right:70px;" hspace="35">
                    <img src="pic/Heart4.jpg" style="width: 485px; float: right; margin-bottom: 50px; margin-right:13px;" hspace="35">
                </div>
            </section>
            <div>
            ...
            <section class="widget-alt recent-posts">
                ...
                <ul>
                    <li>
                        ...
                        <p><a href="news.jsp">A healthy heart can add 10 years to your average survival age.</a><br>5 months ago</p>
                    </li>
                    <li>
                        <a href="news.jsp"><img src="pic/post/2.png" width="80" height="80" alt=""></a>
                        <p><a href="news.jsp">Pets may reduce risk of heart disease, especially cats.</a><br>8 months ago</p>
                    </li>
                    <li>
