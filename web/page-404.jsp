		...
		<div class="page">
			...
			<header class="page-header main-page">
				...
				<section id="logo" class="logo">
					<div>
						<a href="index-2.jsp"><img src="img/blue/logo.png" width="190" height="50" alt="Clinico"></a>
					</div>
				</section>
				<!--/ logo -->
				...
				<nav class="main-nav">
					<ul>
						<li>
							<a href="index-2.jsp"><i class="fa fa-plus"></i>Home</a>
							<ul>
								<li>
									<a href="index-2.jsp">Medical Style</a>
									<ul>
										<li class="text">
											<h2>Main Campus</h2>
											<hr>
						...
						<li class="right">
							<a href="index-2.jsp" class="active"><i class="fa fa-plus"></i>Features</a>
							<ul>
								...
								<li>
									...
									<ul>
										...
										<li><a href="page-404.jsp" class="active">404 Page</a></li>
			...
			<main class="page-content vc_responsive">
				<div class="grid-row">
					...
					<div id="button-404">
						<a class="wpb_button wpb_wpb_button wpb_btn-arrow-right wpb_regularsize" href="index-2.jsp">go back to home page</a>
					</div>
				</div>
			</main>
			<!-- page content -->
