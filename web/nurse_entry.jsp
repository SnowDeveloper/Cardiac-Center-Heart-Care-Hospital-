...
<%
	...
	%>
			 <h4 class="alert_info">Successfully Inserted</h4>
	<% 	}
	%>
      

		<article class="module width_full">
			<header><h3>Add a New Nurse</h3></header>
				
    <form id="NurseEntryForm" method="post" action="nurse_entry2.jsp">
