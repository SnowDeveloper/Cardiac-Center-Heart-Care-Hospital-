		...
		<div class="page">
			...
			<header class="page-header main-page">
				...
				<nav class="main-nav">
					<ul>
						<li>
							<a href="index.jsp"><i class="fa fa-plus"></i>Home</a>
							<ul>
								<li>
									<a href="index.jsp">Medical Style</a>
									<ul>
										<li class="text">
											<h2>Main Campus</h2>
											<hr>
								...
								<li><a href="home-news.jsp">News Style</a></li>
								<li><a href="wellness-home.jsp">Wellness Style</a></li>
								<li><a href="home-one-page.jsp">Home Alternative</a></li>
							</ul>
						</li>
						<li>
							<a href="services.jsp"><i class="fa fa-plus"></i>Services</a>
						</li>
						<li>
							<a href="timetable-week.jsp"><i class="fa fa-plus"></i>Timetable</a>
							<ul>
								<li><a href="timetable-month.jsp">Month View</a></li>
								<li><a href="timetable-week.jsp">Week View</a></li>
								<li><a href="timetable-list.jsp">List View</a></li>
							</ul>
						</li>
						<li>
							<a href="news-default.jsp"><i class="fa fa-plus"></i>News</a>
							<ul>
								<li><a href="news-four-columns.jsp">Four columns</a></li>
								<li><a href="news-three-columns.jsp">Three columns</a></li>
								<li><a href="news-two-columns.jsp">Two columns</a></li>
								<li><a href="news-full-width.jsp">Full width</a></li>
								<li><a href="news-blog-post.jsp">Blog post</a></li>
							</ul>
						</li>
						<li class="right">
							<a href="index.jsp" class="active"><i class="fa fa-plus"></i>Features</a>
							<ul>
								<li><a href="widgets.jsp">Various widgets</a></li>
								<li>
									<a href="#" class="active">Huge number of pages</a>
									<ul>
										<li><a href="about-us.jsp">About Us</a></li>
										<li><a href="locations.jsp" class="active">Locations</a></li>
										<li><a href="doctors.jsp">Our Doctors</a></li>
										<li><a href="full-width-page.jsp">Full-Width Page</a></li>
										<li><a href="page-with-sidebar.jsp">Page with Sidebar</a></li>
										<li><a href="page-with-double-sidebar.jsp">Double Sidebars Page</a></li>
										<li><a href="page-404.jsp">404 Page</a></li>
										<li><a href="page-pricing-table.jsp">Pricing tables</a></li>
									</ul>
								</li>
								<li>
									<a href="feature-unlimited-color.jsp">Unlimited Color Variations</a>
								</li>
								<li><a href="responsive_and_retina_ready.jsp">Retina Ready & Responsive</a></li>
								<li><a href="features-accordion.jsp">Styled Content Items</a></li>
							</ul>
						</li>
						<li class="right">
							<a href="photo-gallery.jsp"><i class="fa fa-plus"></i>Photo Tour</a>
							<ul>
								<li>
									<a href="photo-four-filter.jsp">Four columns</a>
									<ul>
										<li><a href="photo-four-filter.jsp">With filter</a></li>
										<li><a href="photo-four.jsp">Without filter</a></li>
									</ul>
								</li>
								<li>
									<a href="photo-three-filter.jsp">Three columns</a>
									<ul>
										<li><a href="photo-three-filter.jsp">With filter</a></li>
										<li><a href="photo-three.jsp">Without filter</a></li>
									</ul>
								</li>
								<li>
									<a href="photo-two-filter.jsp">Two columns</a>
									<ul>
										<li><a href="photo-two-filter.jsp">With filter</a></li>
										<li><a href="photo-two.jsp">Without filter</a></li>
									</ul>
								</li>
								<li><a href="photo-one.jsp">One column</a></li>
								<li><a href="photo-single.jsp">Single item</a></li>
							</ul>
						</li>
						<li>
							<a href="contacts.jsp"><i class="fa fa-plus"></i>Contacts</a>
						</li>
					</ul>
				</nav>
				<!--/ main nav -->
				...
				<nav id="mobile-main-nav" class="mobile-main-nav">
					...
					<ul>
						<li>
							<i></i><a href="index-2.jsp" class="active">Home</a>
							<ul>
								<li>
									<i></i><a href="index-2.jsp">Medical Style</a>
									<ul>
										<li class="text">
											<h2>Main Campus</h2>
											<hr>
						...
						<li>
							<a href="services.jsp">Servives</a>
						</li>
						<li>
							<i></i><a href="timetable-week.jsp">Timetable</a>
							<ul>
								<li><a href="timetable-month.jsp">Month View</a></li>
								<li><a href="timetable-week.jsp">Week View</a></li>
								<li><a href="timetable-list.jsp">List View</a></li>
						...
						<li>
							<i></i><a href="news-default.jsp">News</a>
							<ul>
								<li><a href="news-four-columns.jsp">Four columns</a></li>
								<li><a href="news-three-columns.jsp">Three columns</a></li>
								<li><a href="news-two-columns.jsp">Two columns</a></li>
						...
						<li>
							<i></i><a href="index-2.jsp">Features</a>
							<ul>
								<li><a href="widgets.jsp">Various widgets</a></li>
								<li>
						...
						<li>
							<i></i><a href="photo-gallery.jsp">Photo Tour</a>
							<ul>
								<li>
									<i></i><a href="photo-four-filter.jsp">Four columns</a>
									<ul>
										<li><a href="photo-four-filter.jsp">With filter</a></li>
										<li><a href="photo-four.jsp">Without filter</a></li>
									</ul>
								...
								<li>
									<i></i><a href="photo-three-filter.jsp">Three columns</a>
									<ul>
										<li><a href="photo-three-filter.jsp">With filter</a></li>
										<li><a href="photo-three.jsp">Without filter</a></li>
									</ul>
								...
								<li>
									<i></i><a href="photo-two-filter.jsp">Two columns</a>
									<ul>
										<li><a href="photo-two-filter.jsp">With filter</a></li>
										<li><a href="photo-two.jsp">Without filter</a></li>
									</ul>
			...
			<section class="page-title">
				<div class="grid-row clearfix">
					...
					<nav class="bread-crumbs">
						...
						<a href="about-us.jsp">Pages</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;
						<a href="#">Locations</a>
				...
				<div class="grid-row">
					<div class="grid-col grid-col-9">
						<section class="detailed-services wpb_content_element">
							...
							<dl>
								...
								<dt id="service14"><i class="fa fa-check"></i>Digestive (Gastroenterology/GI)</dt>
								<dd>
									<div class="details">
										<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam,
										 eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.  
								...
								<dt id="service15"><i class="fa fa-check"></i>Ear, Nose, Throat (Otolaringology/ENT)</dt>
								<dd>
									<div class="details">
										<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam,
										 eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.  
								...
								<dt id="service17"><i class="fa fa-check"></i>Eye (Ophtalmology)</dt>
								<dd>
									<div class="details">
										<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam,
										 eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.  
								...
								<dt id="service19"><i class="fa fa-check"></i>Gynecology</dt>
								<dd>
									<div class="details">
										<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam,
										 eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.  
								...
								<dt id="service21"><i class="fa fa-check"></i>Hospice</dt>
								<dd>
									<div class="details">
										<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam,
										 eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.  
						...
						<div class="grid-row">
							<button class="wpb_button wpb_wpb_button wpb_regularsize">show all</button>
						</div>
					</div>
					...
					<div class="grid-col grid-col-3">
						...
						<section class="widget widget-comments">
							<div class="widget-title">Quick Help</div>
							<div id="help-carousel" class="owl-carousel">
								<div class="item">
									<ul>
										<li>
											<img src="pic/doctor-1.jpg" alt="">
											<p><span class="date">Sed purus purus, tinc</span><br>Bmolestie ut eros. Fusce blandit, sapien eu sollicitudin consectetur.</p>
										</li>
										<li>
											<img src="pic/doctor-2.jpg" alt="">
											<p><span class="date">Sed purus purus</span><br>Bmolestie ut eros. Fusce blandit, sapien eu sollicitudin consectetur.</p>
										</li>
									</ul>
								</div>
								<div class="item">
									<ul>
										<li>
											...
											<p><span class="date">Tincidunt purus purus</span><br>Bmolestie ut eros. Fusce blandit, sapien eu sollicitudin consectetur.</p>
										</li>
										<li>
											<img src="pic/doctor-4.jpg" alt="">
											<p><span class="date">Purus purus, tinc</span><br>Bmolestie ut eros. Fusce blandit, sapien eu sollicitudin consectetur.</p>
										</li>
									</ul>
								</div>
								<div class="item">
									<ul>
										<li>
											<img src="pic/doctor-2.jpg" alt="">
											<p><span class="date">Bmolestie tincidunt</span><br>Bmolestie ut eros. Fusce blandit, sapien eu sollicitudin consectetur.</p>
										</li>
										<li>
											<img src="pic/doctor-3.jpg" alt="">
											<p><span class="date">Fusce purus, tinc</span><br>Bmolestie ut eros. Fusce blandit, sapien eu sollicitudin consectetur.</p>
										</li>
									</ul>
								</div>
							</div>
