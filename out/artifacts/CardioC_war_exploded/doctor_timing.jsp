...
<%
	...
	%>
			 <h4 class="alert_info">Successfully Updated</h4>
	<% 	}
	%>
      

		<article class="module width_full">
			<header><h3>Change Timing of a Doctor</h3></header>
				
    <form id="DoctorUpdationForm" method="get" action="doctor_timing2.jsp">
    
	<fieldset>
		
			
			<label for="did">Enter Doctor ID :</label>
			<input id="did" name="did" type="text" />
			
			<label for="timing">Enter New Timing :</label>
			<input id="timing" name="timing" type="text" />	
				<div class="clear"></div>
