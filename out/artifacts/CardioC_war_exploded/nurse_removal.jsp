...
<%
	...
	%>
		...
		<article class="module width_full">
			<header><h3>Remove a Nurse</h3></header>
				
    <form id="NurseRemovalForm" method="post" action="nurse_removal2.jsp">
    
	<fieldset>
		
			
			<label for="did">Enter Nurse ID :</label>
